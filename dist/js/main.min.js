...
const motionsCommandMap={diw:()=>{docs.pressKey(keys.ArrowLeft,!0,!1)?.pressKey(keys.ArrowRight,!0,!0)?.pressKey(keys.delete,!1,!1)},ciw:()=>docs.pressKey(keys.ArrowLeft,!0,!1)?.pressKey(keys.ArrowRight,!0,!0)?.pressKey(keys.delete,!1,!1)?.switchToMode("insert"),gg:()=>docs.pressKey(keys.home,!0,!1),dd:()=>docs.pressKey(keys.home)?.pressKey(keys.shift)?.pressKey(keys.end,!1,!0)?.pressKey(keys.delete)?.pressKey(keys.delete),cw:()=>docs.pressKey(keys.ArrowRight,!0,!0)?.pressKey(keys.delete,!1,!1)?.switchToMode("insert"),dw:()=>{docs.pressKey(keys.ArrowRight,!0,!0)?.pressKey(keys.delete,!1,!1)},yy:()=>docs.pressKey(keys.home)?.pressKey(keys.shift)?.pressKey(keys.end,!1,!0)?.copyText()?.stopSelecting()};
...
docs.keyListenerStatus||docs.keydownInit();const checkBindings=(o,e)=>{const r=docs.keyArray;var n,m,t,s,i=r.some(o=>!keysThatAreUsed.includes(o.toString())),a=!isNaN(mode.number)&&mode.number<50?mode.number:1;for([n,m]of Object.entries(commandMap))for(const d of Object.entries(m))if(d[0].includes(o)&&r.includes(n)&&("Escape"===n||!mode.isInMotion)){for(let o=0;o<a;o++)d[1]();!mode.isInMotion&&isNaN(parseInt(n))&&clearArray(r)}for([t,s]of Object.entries(motionsCommandMap))if(mode.isInMotion&&r.join("").replace(/,/g,"").includes(t)){for(let o=0;o<a;o++)s();clearArray(r),mode.isInMotion=!1}if("normal"===o&&i)fancyLogError("Not a valid key"),clearArray(r);else{let e="";console.log("keyArray",r);for(let o=0;o<r.length;o++)r[o].toString().match(/[0-9]/g)&&(e+=parseInt(r[o].toString()),console.log("Number is now",e));isNaN(parseInt(e))?mode.number=1:mode.number=parseInt(e)}};
...
const commandMap={k:{normal:()=>docs.pressKey(keys.ArrowUp),visual:()=>docs.pressKey(keys.ArrowUp)},j:{normal:()=>docs.pressKey(keys.ArrowDown),visual:()=>docs.pressKey(keys.ArrowDown)},l:{normal:()=>docs.pressKey(keys.ArrowRight),visual:()=>docs.pressKey(keys.ArrowRight)},h:{normal:()=>docs.pressKey(keys.ArrowLeft),visual:()=>docs.pressKey(keys.ArrowLeft)},w:{normal:()=>docs.pressKey(keys.ArrowRight,!0),visual:()=>docs.pressKey(keys.ArrowRight,!0)},e:{normal:()=>docs.pressKey(keys.ArrowRight,!0),visual:()=>docs.pressKey(keys.ArrowRight,!0)},b:{normal:()=>docs.pressKey(keys.ArrowLeft,!0),visual:()=>docs.pressKey(keys.ArrowLeft,!0)},i:{normal:()=>docs.switchToMode("insert"),visual:()=>docs.switchToMode("insert")},a:{normal:()=>docs.pressKey(keys.ArrowRight)?.switchToMode("insert"),visual:()=>docs.pressKey(keys.ArrowRight)?.switchToMode("insert")},Escape:{normal:()=>docs.switchToMode("normal").isInMotion=!1,visual:()=>docs.switchToMode("insert").pressKey(keys.ArrowLeft).isInMotion=!1,insert:()=>docs.switchToMode("normal").isInMotion=!1},v:{normal:()=>docs.pressKey(keys.shift)?.switchToMode("visual")},V:{normal:()=>docs.pressKey(keys.home)?.pressKey(keys.shift)?.pressKey(keys.end,!1,!0)?.switchToMode("visual")},x:{normal:()=>docs.pressKey(keys.delete,!1,!1),visual:()=>docs.pressKey(keys.delete,!1,!1)},u:{normal:()=>docs.pressKey(keys.z,!0)?.switchToMode("normal").pressKey(keys.ArrowRight),visual:()=>docs.pressKey(keys.z,!0)?.switchToMode("normal").pressKey(keys.ArrowRight)},d:{normal:()=>mode.isInMotion=!0,visual:()=>docs.pressKey(keys.delete,!1,!1)?.switchToMode("normal")},D:{normal:()=>docs.pressKey(keys.home)?.pressKey(keys.shift)?.pressKey(keys.end,!1,!0)?.pressKey(keys.delete)?.pressKey(keys.delete)},c:{normal:()=>mode.isInMotion=!0,visual:()=>docs.pressKey(keys.delete,!1,!1)?.switchToMode("insert")},$:{normal:()=>docs.pressKey(keys.end),visual:()=>docs.pressKey(keys.end)},0:{normal:()=>{isNaN(mode.number)?docs.pressKey(keys.home):(console.log("0 is pressed and num is not nan",mode.number),console.log("after",mode.number))},visual:()=>docs.pressKey(keys.home)},"^":{normal:()=>docs.pressKey(keys.home),visual:()=>docs.pressKey(keys.home)},g:{normal:()=>mode.isInMotion=!0,visual:()=>mode.isInMotion=!0},G:{normal:()=>docs.pressKey(keys.end,!0),visual:()=>docs.pressKey(keys.end,!0)},y:{normal:()=>mode.isInMotion=!0,visual:()=>docs.copyText()?.pressKey(keys.arrowRight,!1,!1)?.pressKey(keys.ArrowLeft,!1,!1)?.switchToMode("normal")},p:{normal:()=>{docs.pressKey(keys.end)?.pressKey(keys.enter)?.pasteText()}},o:{normal:()=>docs.pressKey(keys.end)?.pressKey(keys.enter)?.switchToMode("insert")},O:{normal:()=>docs.pressKey(keys.end)?.pressKey(keys.ArrowUp)?.pressKey(keys.enter)?.switchToMode("insert")},Backspace:{normal:()=>docs.pressKey(keys.ArrowLeft),visual:()=>docs.pressKey(keys.ArrowLeft)}};
