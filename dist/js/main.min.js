...
const motionsCommandMap={diw:()=>{docs.pressKey(keys.ArrowLeft,!0,!1)?.pressKey(keys.ArrowRight,!0,!0)?.pressKey(keys.delete,!1,!1)},ciw:()=>docs.pressKey(keys.ArrowLeft,!0,!1)?.pressKey(keys.ArrowRight,!0,!0)?.pressKey(keys.delete,!1,!1)?.switchToMode("insert"),gg:()=>docs.pressKey(keys.home,!0,!1),dd:()=>docs.pressKey(keys.home)?.pressKey(keys.shift)?.pressKey(keys.end,!1,!0)?.copyText(!0)?.pressKey(keys.delete),cw:()=>docs.pressKey(keys.ArrowRight,!0,!0)?.pressKey(keys.delete,!1,!1)?.copyText()?.switchToMode("insert"),dw:()=>{docs.pressKey(keys.ArrowRight,!0,!0)?.copyText()?.pressKey(keys.delete,!1,!1)},yy:()=>docs.pressKey(keys.home)?.pressKey(keys.shift)?.pressKey(keys.end,!1,!0)?.copyText()?.stopSelecting(),yiw:()=>docs.pressKey(keys.ArrowLeft,!0,!1)?.pressKey(keys.ArrowRight,!0,!0)?.copyText()?.stopSelecting(),yw:()=>docs.pressKey(keys.ArrowRight,!0,!0)?.copyText()?.stopSelecting(),dj:()=>docs.pressKey(keys.home)?.pressKey(keys.shift)?.pressKey(keys.end,!1,!0)?.pressKey(keys.ArrowDown,!0,!0)?.pressKey(keys.ArrowDown,!0,!0)?.copyText()?.pressKey(keys.delete),dk:()=>docs.pressKey(keys.ArrowDown,!0,!1)?.pressKey(keys.ArrowUp,!0,!0)?.pressKey(keys.ArrowUp,!0,!0)?.copyText()?.pressKey(keys.delete)};
...
const commandMap={$:{normal:()=>docs.pressKey(keys.end),visual:()=>docs.pressKey(keys.end)},0:{normal:()=>{(isNaN(mode.number)||1===mode.number&&0!==docs.keyArray.length)&&docs.pressKey(keys.home)},visual:()=>docs.pressKey(keys.home)},Backspace:{normal:()=>docs.pressKey(keys.ArrowLeft),visual:()=>docs.pressKey(keys.ArrowLeft)},D:{normal:()=>docs?.pressKey(keys.end,!1,!0)?.pressKey(keys.delete)},Escape:{normal:()=>docs.switchToMode("normal").isInMotion=!1,visual:()=>docs.switchToMode("normal").pressKey(keys.ArrowLeft).isInMotion=!1,insert:()=>docs.switchToMode("normal").isInMotion=!1,visualLine:()=>docs.switchToMode("normal").isInMotion=!1},G:{normal:()=>docs.pressKey(keys.end,!0),visual:()=>docs.pressKey(keys.end,!0),visualLine:()=>docs.pressKey(keys.end,!0)},O:{normal:()=>docs.pressKey(keys.end)?.pressKey(keys.ArrowUp)?.pressKey(keys.enter)?.switchToMode("insert")},V:{normal:()=>docs.pressKey(keys.home)?.pressKey(keys.shift)?.pressKey(keys.end,!1,!0)?.switchToMode("visualLine")},"^":{normal:()=>docs.pressKey(keys.home),visual:()=>docs.pressKey(keys.home),visualLine:()=>docs.pressKey(keys.home)},a:{normal:()=>docs.pressKey(keys.ArrowRight)?.switchToMode("insert"),visual:()=>docs.pressKey(keys.ArrowRight)?.switchToMode("insert")},b:{normal:()=>docs.pressKey(keys.ArrowLeft,!0),visual:()=>docs.pressKey(keys.ArrowLeft,!0)},c:{normal:()=>mode.isInMotion=!0,visual:()=>docs.pressKey(keys.delete,!1,!1)?.switchToMode("insert")},d:{normal:()=>mode.isInMotion=!0,visual:()=>docs.pressKey(keys.delete,!1,!1)?.switchToMode("normal"),visualLine:()=>(console.log("d"),docs.pressKey(keys.delete,!1,!1)?.switchToMode("normal"))},e:{normal:()=>docs.pressKey(keys.ArrowRight,!0),visual:()=>docs.pressKey(keys.ArrowRight,!0)},g:{normal:()=>mode.isInMotion=!0,visual:()=>mode.isInMotion=!0},h:{normal:()=>docs.pressKey(keys.ArrowLeft),visual:()=>docs.pressKey(keys.ArrowLeft),visualLine:()=>docs.pressKey(keys.ArrowLeft,!1,!0)?.selectLine()},i:{normal:()=>docs.switchToMode("insert"),visual:()=>docs.switchToMode("insert"),visualLine:()=>docs.switchToMode("insert")},j:{normal:()=>docs.pressKey(keys.ArrowDown),visual:()=>docs.pressKey(keys.ArrowDown),visualLine:()=>docs.pressKey(keys.ArrowDown,!1,!0)?.selectLine()},k:{normal:()=>docs.pressKey(keys.ArrowUp),visual:()=>docs.pressKey(keys.ArrowUp),visualLine:()=>docs.pressKey(keys.ArrowUp,!1,!0)?.selectLine()},l:{normal:()=>docs.pressKey(keys.ArrowRight),visual:()=>docs.pressKey(keys.ArrowRight),visualLine:()=>docs.pressKey(keys.ArrowRight,!1,!0)?.selectLine()},o:{normal:()=>docs.pressKey(keys.end)?.pressKey(keys.enter)?.switchToMode("insert")},p:{normal:()=>{docs.pressKey(keys.end)?.pasteText()}},u:{normal:()=>docs.pressKey(keys.z,!0)?.switchToMode("normal").pressKey(keys.ArrowRight),visual:()=>docs.pressKey(keys.z,!0)?.switchToMode("normal").pressKey(keys.ArrowRight)},v:{normal:()=>docs.pressKey(keys.shift)?.switchToMode("visual")},w:{normal:()=>docs.pressKey(keys.ArrowRight,!0),visual:()=>docs.pressKey(keys.ArrowRight,!0),visualLine:()=>docs.pressKey(keys.ArrowRight,!0)?.selectLine()},x:{normal:()=>docs.pressKey(keys.ArrowRight,!1,!0)?.copyText()?.pressKey(keys.delete),visual:()=>docs.copyText()?.pressKey(keys.delete,!1,!1),visualLine:()=>docs.copyText()?.pressKey(keys.delete,!1,!1)},y:{normal:()=>mode.isInMotion=!0,visual:()=>docs.copyText()?.stopSelecting()?.switchToMode("normal"),visualLine:()=>docs.copyText()?.stopSelecting()?.switchToMode("normal")}};
