...
const motionsCommandMap={diw:()=>{docs.pressKey(keys.ArrowLeft,!0,!1)?.pressKey(keys.ArrowRight,!0,!0)?.pressKey(keys.delete,!1,!1)},ciw:()=>docs.pressKey(keys.ArrowLeft,!0,!1)?.pressKey(keys.ArrowRight,!0,!0)?.pressKey(keys.delete,!1,!1)?.switchToMode("insert"),gg:()=>docs.pressKey(keys.home,!0,!1),dd:()=>docs.pressKey(keys.home)?.pressKey(keys.shift)?.pressKey(keys.end,!1,!0)?.pressKey(keys.delete)?.pressKey(keys.delete),cw:()=>docs.pressKey(keys.ArrowRight,!0,!0)?.pressKey(keys.delete,!1,!1)?.switchToMode("insert"),dw:()=>{docs.pressKey(keys.ArrowRight,!0,!0)?.pressKey(keys.delete,!1,!1)}};
